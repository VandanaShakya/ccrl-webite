      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 items-stretch">
          ...
          <div className="w-full flex flex-col">
            <div className="flex items-center mb-4">
              <div className="h-10 w-20 flex items-center justify-center mr-2">
                <img src={images.logo} alt="logo" className="h-10 w-20 object-contain" />
              </div>
          ...
          {/* Column 4: Extra (you can place social icons, quick links, gallery, etc.) */}
          <div className="w-full flex flex-col">
            <h4 className="text-white text-lg font-semibold mb-4 border-b-2 border-blue-500 w-25 pb-2 inline-block">
              Quick Links
            </h4>
