...
const HowitWorks = () => {
  ...
  const { scrollYProgress } = useScroll({
    target: ref,
    offset: ["start 50%", "end -6%"], // triggers when section enters and exits viewport
  });

  // Animate the blue line’s height and fade
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/50 to-black/70 flex items-center">
                        ...
                        <div className="max-w-7xl w-full mx-auto px-6 md:px-12">
                            ...
                            <button
                                ...
                                className="mt-6 inline-block px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-lg shadow-lg hover:from-blue-700 hover:to-cyan-600 transition-all"
                            >
                                Explore Our Process
                            </button>
        ...
        <div className="flex flex-col space-y-24 relative">
          {howWorksData?.map((step, index) => (
            ...
            >
              ...
              {/* Step Number Circle at End of Branch */}
              <div
                            ...
                            >
                                ...
                                <div className="mb-8">
                                    ...
                                    <span className="text-2xl font-normal text-gray-600">
                                        {/* VAT is a feature, so it will be listed below the main price for clarity */}
                                    </span>
                                </div>
                                ...
                                <ul className="space-y-3 text-center mb-10">
                                    ...
                                    {tier.features.map((feature, fIndex) => (
                                        <li key={fIndex} className="text-lg text-gray-500">
                                            {feature}
                                        </li>
                                    ))}
                                </ul>
